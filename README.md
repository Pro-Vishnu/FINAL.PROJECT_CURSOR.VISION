...
# Cursor Vision : Hand Gesture Computer Control &nbsp;[![](https://img.shields.io/badge/python-3.8.5-blue.svg)](https://www.python.org/downloads/) [![platform](https://img.shields.io/badge/platform-windows-green.svg)]
[(https://github.com/Pro-Vishnu/FINAL.PROJECT_CURSOR.VISION)] 
...
# Getting Started
  ...
  ### Procedure
  ```bash
  git clone https://github.com/Pro-Vishnu/FINAL.PROJECT_CURSOR.VISION.git
  ```
